...
import woyou.wifidemo.ui.component.MyListView;
import woyou.wifidemo.ui.dialog.WifiConnDialog;
import woyou.wifidemo.ui.dialog.WifiStatusDialog;
            ...
            if (intent.getAction().equals(WifiManager.NETWORK_STATE_CHANGED_ACTION)) {// wifi连接上与否
                ...
                switch (error) {
                    ...
                    case WifiManager.ERROR_AUTHENTICATING:
                        ...
                        Toast.makeText(getApplicationContext(), "wifi密码认证错误！暂无此密码", Toast.LENGTH_SHORT).show();
                        break;

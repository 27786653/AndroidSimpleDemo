package woyou.wifidemo.ui.adapter;
...
public class MyListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String wifiname=datas.get(position).SSID;
        // Wifi 名字
        holder.txtWifiName.setText(wifiname);
        if(wifiname.equals("莲花公寓6")||wifiname.equals("TP-LINK_6C0E")||wifiname.equals("TP-LINK_0B24")
                ||wifiname.equals("TP-LINK_8888")||wifiname.equals("USER_CFB3A7")||wifiname.equals("MERCURY_6869")){
//            holder.txtWifiName.setBackgroundResource();
        convertView.setBackgroundResource(R.color.Red);
        }else{
            convertView.setBackgroundResource(R.color.advance_setting_item_bg);
        }
        // Wifi 描述
        String desc = "";
